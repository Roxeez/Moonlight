...
{
    public abstract class GenericRepository<TEntity, TDto, TObjectId, TContext> : IGenericRepository<TObjectId, TDto>
    ...
    public class Repository<TEntity, TDto, TContext> : GenericRepository<TEntity, TDto, int, TContext>, IRepository<TDto>
    ...
    public class StringRepository<TEntity, TDto, TContext> : GenericRepository<TEntity, TDto, string, TContext>, IStringRepository<TDto>
