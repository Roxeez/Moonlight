...
{
    internal abstract class GenericCachedRepository<TEntity, TDto, TObjectId, TContext> : GenericRepository<TEntity, TDto, TObjectId, TContext>
    ...
    internal class CachedRepository<TEntity, TDto, TContext> : GenericCachedRepository<TEntity, TDto, int, TContext>, IRepository<TDto>
    ...
    internal class CachedStringRepository<TEntity, TDto, TContext> : GenericCachedRepository<TEntity, TDto, string, TContext>, IStringRepository<TDto>
