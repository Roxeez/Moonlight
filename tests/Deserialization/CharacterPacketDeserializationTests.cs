...
{
    public class CharacterPacketDeserializationTests : DeserializationTests
    {
        [Fact]
        public void At_Packet()
        {
            AtPacket packet = Deserialize<AtPacket>("at 1234567 2 140 148 2 0 1 1 -1");
        ...
        {
            CInfoPacket packet = Deserialize<CInfoPacket>("c_info Mermoud - -1 2858 ~Happy~(Membre) 1234567 0 0 1 9 2 14 0 0 0 0 0 0 0");
        ...
        {
            FsPacket packet = Deserialize<FsPacket>("fs 2");
        ...
        {
            FdPacket packet = Deserialize<FdPacket>("fd 49698 14 100 1");
        ...
        {
            GoldPacket packet = Deserialize<GoldPacket>("gold 1932933 0");
        ...
        {
            LevPacket packet = Deserialize<LevPacket>("lev 50 3490279 45 122055 11469080 265000 49698 71 0 0 3 0");
        ...
        {
            NcifPacket packet = Deserialize<NcifPacket>("ncif 3 2304");
        ...
        {
            PairyPacket packet = Deserialize<PairyPacket>("pairy 1 1234567 4 2 28 0");
        ...
        {
            SpPacket packet = Deserialize<SpPacket>("sp 115488 1000000 10000 10000");
        ...
        {
            StatPacket packet = Deserialize<StatPacket>("stat 3300 3395 1340 1350 0 416");
        ...
        {
            WalkPacket packet = Deserialize<WalkPacket>("walk 140 87 1 12");
